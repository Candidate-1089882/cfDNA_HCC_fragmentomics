...
python Generate_samples_purity_corrected.py \
    --cfDNA_dir "$CFDNA_DIR" \
...
# Example usage:
# sbatch -p long 01-create_samples_2.sh -w /users/ludwig/cnr137 -c /well/ludwig/users/cnr137/methylation_model/healthy_cfdna_samples_extended -t /well/ludwig/users/cnr137/methylation_model/tissue_samples -o /well/ludwig/users/cnr137/methylation_model/generated_samples_tumouronly_purity_corrected
